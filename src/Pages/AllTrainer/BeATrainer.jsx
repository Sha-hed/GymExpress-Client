...
const BeATrainer = () => {
    ...
    return (
        <div className="pt-20">
            <div className="max-w-4xl mx-auto  p-5 my-5 text-white rounded-xl dark:border-zinc-700 dark:bg-zinc-900 ">
                    ...
                    <div className="flex flex-col space-y-5 my-5">
                        <div className="flex justify-between gap-5">
                            <div className="w-1/2 flex flex-col space-y-3">
                                ...
                                <input className="p-3 border text-black outline-none w-full rounded-xl border-gray-400" type="text" name="name" id="" />
                            </div>
                            <div className="w-1/2 flex flex-col space-y-3">
                                <label className="font-semibold text-xl w-full">Email</label>
                                <input className="text-black p-3 border outline-none w-full rounded-xl" defaultValue={user?.email} readOnly type="email" name="email" id="" />
                            </div>
                        </div>
                        <div className="flex justify-between gap-5">
                            <div className="w-1/2 flex flex-col space-y-3">
                                <label className="font-semibold text-xl w-full">Age</label>
                                <input className="text-black p-3 border outline-none w-full rounded-xl" type="number" name="age" id="" />
                            </div>
                            <div className="w-1/2 flex flex-col space-y-3">
                                <label className="font-semibold text-xl w-full">PhotoURL</label>
                                <input className="text-black p-3 border outline-none w-full rounded-xl" type="text" name="image" id="" />
                            </div>
                        </div>
                        <div className="flex justify-between gap-5">
                            <div className="w-1/2 flex flex-col space-y-3">
                            ...
                            <div className="w-1/2 flex flex-col space-y-3">
                                ...
                                <input className="text-black p-3 border outline-none w-full rounded-xl" type="text" name="time" id="" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <input className="text-black p-3 border outline-none w-1/2 rounded-xl" type="number" name="experience" id="" />
                        </div>
                        <div className="flex flex-col">
