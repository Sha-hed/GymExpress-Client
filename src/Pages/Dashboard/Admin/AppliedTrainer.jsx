...
const AppliedTrainer = () => {
    ...
    return (
        <div>
            ...
            {
                mod && (
                    <div className="absolute z-10 top-1/4 left-1/3 w-[500px] h-[300px] bg-gray-100 shadow-2xl ">
                        {
                            selectedTrainer && <div className="p-5 rounded-2xl">
                                ...
                                <div className="flex flex-col space-y-3">
                                    ...
                                    <h1>Age : {selectedTrainer.name}</h1>
                                    <h1>Experience : {selectedTrainer.email}</h1>
