import GymIntro from '../../../assets/images2/GymIntro2.jpg'
import GymIntro22 from '../../../assets/images2/GymCover.png'
const Intro = () => {
    return (
            ...
            <div className='max-w-7xl mx-auto flex gap-32 p-10 '>
                ...
                <div className='w-[510px]'>
                    ...
                    <div className='flex justify-center'>
                        <button type="button" className="mt-5 text-gray-900 bg-white hover:bg-gray-100  focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 me-2 mb-2">
